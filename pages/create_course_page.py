...
class CreateCoursePage(BasePage):
    ...
    def check_visible_create_course_form(
        ...
        expect(self.create_course_max_score).to_be_visible()
        expect(self.create_course_max_score).to_have_value(max_score)

        expect(self.create_course_min_score).to_be_visible()
        expect(self.create_course_min_score).to_have_value(min_score)
    ...
    def fill_create_course_form(
        ...
        self.create_course_max_score.fill(max_score)
        expect(self.create_course_max_score).to_have_value(max_score)

        self.create_course_min_score.fill(min_score)
        expect(self.create_course_min_score).to_have_value(min_score)
    ...
    def fill_create_exercise_form(
        ...
        expect(exercise_description_input).to_have_value(title)